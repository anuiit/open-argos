...
Benchmark-driven development working copy for the local `argos` CLI (core 0.9.0) and the `argos-tools` plugin facade.
...
- Kimi development route: official `kimi` CLI over ACP stdio, provider `kimi`, model `kimi-code/k3`; no OpenCode/K2.x fallback.
